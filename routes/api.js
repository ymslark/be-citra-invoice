...
router.get('/CF/deleted', jwtAuth(), checkPermission(roles), CFController.deletedFilterData)
...
router.get('/SCI/deleted', jwtAuth(), checkPermission(roles), SCIController.deletedFilterData)
...
router.get('/CII/deleted', jwtAuth(), checkPermission(roles), CIIController.deletedFilterData)
...
router.get('/Barang/getAll', jwtAuth(), checkPermission(roles), BarangController.getAllNama)
router.get('/Barang/getAllBarang', jwtAuth(), checkPermission(roles), BarangController.getAll)
router.get('/Barang/getAllCode', jwtAuth(), checkPermission(roles), BarangController.getAllCode)
router.get('/Barang/deleted', jwtAuth(), checkPermission(roles), BarangController.deleted)
router.get('/Barang/detail/:id', jwtAuth(), checkPermission(roles), BarangController.show)
router.get('/Barang/filterData', jwtAuth(), checkPermission(roles), BarangController.filterData)
...
router.put('/Barang/:id', jwtAuth(), checkPermission(roles), BarangController.update)
router.patch('/Barang/restore/:id', jwtAuth(), checkPermission(['super_admin', 'developer']), BarangController.restore)
...
router.get('/Memo/deleted', jwtAuth(), checkPermission(roles), MemoController.deletedFilterData)
